...
const Applyplan1 = ({ currentId }) => {
    const [ subcriptiondata , setsubcriptiondata ] = useState({  ptype:'',price:'', mobileno:'', Address:'',Duration:'',currentLimit:7,currentDownload:0});
